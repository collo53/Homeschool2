...
export default function AccountHero() {
  ...
  const handleEmailChange = async () => {
    ...
    try {
      const response = await axios.post("https://homeschool2.onrender.com/Hub/update-email/", {
        old_email: oldEmail,
        new_email: newEmail,
      });
  ...
  const handlePasswordChange = async () => {
    ...
    try {
      const response = await axios.post("https://homeschool2.onrender.com/Hub/update-password/", {
        email: newEmail,
