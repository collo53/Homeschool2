  ...
  return (
    <div className="fixed top-0 left-0 h-screen w-72 bg-black text-white flex flex-col items-center p-5 shadow-lg z-50">
      ...
      <div className="flex flex-col items-center mt-4">
        ...
        <p className="text-sm font-medium text-gray-400 text-center">Student Learning Management</p>
      </div>
      ...
      <ul className="mt-10 space-y-5 w-full">
        ...
        <SidebarLink icon={<FaEnvelope />} label="Messages" to="/pages/studentmessages/" />
        <SidebarLink icon={<FaUsers />} label="Account" to="/pages/studentaccount/" />
      </ul>
    </div>
  );
}
